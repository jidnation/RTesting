...
class AbbreviationLibrary extends StatefulHookWidget {
  const AbbreviationLibrary({Key? key}) : super(key: key);

  @override
  State<AbbreviationLibrary> createState() => _AbbreviationLibraryState();
}

class _AbbreviationLibraryState extends State<AbbreviationLibrary> {
  @override
