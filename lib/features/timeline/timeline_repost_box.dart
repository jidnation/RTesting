  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
        ...
        Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                if (false) {
                  ...
                  Future.delayed(const Duration(seconds: 3), () {
                    globals.userBloc!.add(
                        GetRecipientProfileEvent(email: tPostOwnerInfo.authId));
                    tPostOwnerInfo.authId == globals.user!.id
                        ...
                        : RouteNavigators.route(
                            ...
                            RecipientAccountProfile(
                              ...
                              recipientImageUrl: tPostOwnerInfo.profilePicture,
            ...
            Row(children: [
                  ...
                  CustomText(
                    text: tPostInfo.location.toString().length > 23
                        ? tPostInfo.location
                            ...
                            .toCapitalized()
                            .substring(0, 23)
                        : tPostInfo.location.toString().trim().toCapitalized(),
              ...
              CustomText(
                text: Helper.parseUserLastSeen(tPostInfo.createdAt.toString()),
                color: const Color(0xff252525).withOpacity(0.5),
                size: 11.44,
                weight: FontWeight.w600,
              ),
        ...
        SizedBox(height: tPostInfo.repostedPost!.content!.isNotEmpty ? 8 : 0),
        Visibility(
            visible: images.isNotEmpty,
            child: TimeLinePostMedia(post: tPostInfo.repostedPost!)),
        SizedBox(
            height:
                tPostInfo.repostedPost!.videoMediaItem!.isNotEmpty ? 10 : 0),
        ...
        SizedBox(
            height:
                tPostInfo.repostedPost!.audioMediaItem!.isNotEmpty ? 10 : 0),
        Visibility(
          visible: tPostInfo.repostedPost!.audioMediaItem!.isNotEmpty,
          child: Container(
            height: tPostInfo.repostedPost!.audioMediaItem!.isNotEmpty ? 59 : 0,
