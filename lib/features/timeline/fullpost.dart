...
//
// class TimeLineFullPostScreen extends StatefulHookWidget {
...
//
//   const TimeLineFullPostScreen({required this.timeLineModel, Key? key})
//       : super(key: key);
//
//   @override
//   State<TimeLineFullPostScreen> createState() => _TimeLineFullPostScreenState();
// }
//
// class _TimeLineFullPostScreenState extends State<TimeLineFullPostScreen> {
//   @override
//   void initState() {
//     globals.socialServiceBloc!.add(GetAllCommentsOnPostEvent(
//         postId: widget.timeLineModel!.getPostFeed.post!.postId,
//         pageLimit: 50,
//         pageNumber: 1));
//     super.initState();
//   }
...
//     var postFeedModel =
//         timeLineFeedStore.getPostModel(timeLineModel: widget.timeLineModel!);
//
//     final post = useState<PostFeedModel>(postFeedModel);
...
//     final commentOption = postFeedModel.post!.commentOption;
...
//     useMemoized(() {
//       globals.socialServiceBloc!.add(GetAllCommentsOnPostEvent(
//           postId: postFeedModel.postId, pageLimit: 50, pageNumber: 1));
//     });
//
//     Set active = {};
//
...
//           .add(GetPostEvent(postId: postFeedModel.postId));
//     }
//
//     Widget buildEmoji() {
//       return SizedBox(
...
//               debugPrint("PostId: ${postFeedModel.postId} ");
//               // _currentPost.value!.postId = postFeedModel!.postId;
...
//                                                   handleTap(postFeedModel.post);
//
//                                                   if (active.contains(
//                                                       postFeedModel.post)) {
//                                                     if ((postFeedModel.vote ??
//                                                             [])
//                                                         .isEmpty) {
//                                                       setState(() {
//                                                         shoutoutPost.value =
...
//     // debugPrint("Comment option: ${postFeedModel!.post!.commentOption}");
//     debugPrint("PostFeedModel: ${postFeedModel?.post!.content}");
//     debugPrint("PostFeedModel: ${postFeedModel?.profilePicture}");
//     debugPrint("PostModel: ${postFeedModel!.post!.postOwnerProfile!.username}");
//     switch (postFeedModel.post!.commentOption) {
//       case "everyone":
//         return Padding(
...
//         if (postFeedModel.postOwnerId == globals.userId || isReaching) {
//           return Padding(
//             padding: const EdgeInsets.symmetric(horizontal: 21.0),
//             child: SizedBox(
//               width: MediaQuery.of(context).size.width * 0.85,
...
//         if (postFeedModel.post!.mentionList!.contains(globals.user!.username)) {
//           return Padding(
//             padding: const EdgeInsets.symmetric(horizontal: 21.0),
//             child: SizedBox(
//               width: MediaQuery.of(context).size.width * 0.85,
...
// //
// //   const TimeLineFullPostScreen({required this.postFeedModel, Key? key})
// //       : super(key: key);
// //
// //   @override
// //   State<TimeLineFullPostScreen> createState() => _TimeLineFullPostScreenState();
